...
namespace thepathbackend.Controllers
{
    ...
    public class AcademyListController : ControllerBase
    {
        private static List<AcademyModel> _Academy = new List<AcademyModel>()
        {
            ...
            new AcademyModel { Id = 3, Name = "Inside BJJ Academy", Address = "3422 W Hammer Ln suite g, Stockton, CA 95219" },
            new AcademyModel { Id = 4, Name = "Stockton JiuJitsu Academy", Address = "2222 Grand Canal Blvd #8, Stockton, CA 95207" },
            new AcademyModel { Id = 5, Name = "Stockton Dominate MMA", Address = "6360 Pacific Ave #1, Stockton, CA 95207" },
            new AcademyModel { Id = 6, Name = "Nick Diaz Academy", Address = "3802 Wilcox Rd, Stockton, CA 95215" },
            ...
            new AcademyModel { Id = 11, Name = "Strive Jiu Jitsu & Fitness Academy", Address = "651 N Cherokee Ln Suite E, Lodi, CA 95240" },
